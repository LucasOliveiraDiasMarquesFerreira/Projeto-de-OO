...
public class mypet {
		...
		public static void main(String[] args) {
			...
			Cachorro cachorro = new Cachorro("bob", "20/03/2022", "macho", "pinscher", "pequeno");
			Gato gato = new Gato("xana", "01/02/2021", "macho", "siamês", "sólida");
			Coelho coelho = new Coelho("Flocos", "12/01/2022", "fêmea", "angorá");
			...
			Vacina vacinaCachorro = new Vacina("raiva", "08/12/2022");
			Vacina vacinaGato = new Vacina("raiva", "08/12/2022");
